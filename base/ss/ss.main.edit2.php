            ...
            <div  class="container">
                ...
                <form id="formadd" method="post" action="ss.main.edit.sql.php">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php
                            echo '<input type="text" name="type_netA" id="aa1" class="form-control" value="'.$link['sign_net'].'" readonly />';
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php
                            echo '<input type="text" name="type_netB" id="ab1" class="form-control" value="'.$link['sign_net2'].'" readonly />';
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php
                            echo '<input type="text" name="date_in" id="i" class="form-control" value="'.date("d.m.Y", strtotime($link['in_exp'])).'" />';
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="sign" id="n" class="form-control" value="межсетевое" readonly />
                        </div>
                    </div>
                    <div class="form-group">
...
<!-- MyScript -->
<script src="ss.main.edit2.js"></script>
<script>
    $(function() {
