                ...
                <div  class="container">
                    ...
                    <form id="formadd" method="post" action="ss.main.add.sql.php">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="type_netA" id="aa1" class="form-control" value="" readonly />
                                <input type="hidden" name="type_netA2" id="aa2" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="type_netB" id="ab1" class="form-control" value="" readonly />
                                <input type="hidden" name="type_netB2" id="ab2" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="form-group">
