                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="grounding1" id="l1" class="form-control" onchange="javascript:selectPower('l1');">
                                <?php
                                if($node['ground'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['ground'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['ground'] == 1) { $str = 'selected'; } else { $str = ''; }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="generator1" id="m1" class="form-control" onchange="javascript:selectPower('m1');" >
                                <?php
                                if($node['el_generator'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['el_generator'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['el_generator'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select name="battery1" id="n1" class="form-control" onchange="javascript:selectPower('n1');">
                                <?php
                                if($node['el_battery'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['el_battery'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['el_battery'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="acdc1" id="o1" class="form-control">
                                <?php
                                if($node['el_type'] == '') { $str = 'selected'; } else { $str = ''; }
                                echo '<option '.$str.'></option>';
                                if($node['el_type'] == 'AC') { $str = 'selected'; } else { $str = ''; }
                                echo '<option '.$str.'>AC</option>';
                                if($node['el_type'] == 'DC') { $str = 'selected'; } else { $str = ''; }
                                echo '<option '.$str.'>DC</option>';
                                if($node['el_type'] == 'AC/DC') { $str = 'selected'; } else { $str = ''; }
                                echo '<option '.$str.'>AC/DC</option>';
                                if($node['el_type'] == 'нет данных') { $str = 'selected'; } else { $str = ''; }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="outpower" id="outpower" class="form-control" onchange="javascript:selectControl('outpower');">
                                <?php
                                if($node['m_power'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['m_power'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['m_power'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="doors" id="doors" class="form-control" onchange="javascript:selectControl('doors');">
                                <?php
                                if($node['m_door'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['m_door'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['m_door'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="temr" id="temr" class="form-control" onchange="javascript:selectControl('temr');">
                                <?php
                                if($node['m_temperature'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['m_temperature'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['m_temperature'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="humidity" id="humidity" class="form-control" onchange="javascript:selectControl('humidity');">
                                <?php
                                if($node['m_humidity'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['m_humidity'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['m_humidity'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="smoke" id="smoke" class="form-control" onchange="javascript:selectControl('smoke');">
                                <?php
                                if($node['m_smoke'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['m_smoke'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['m_smoke'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="water" id="water" class="form-control" onchange="javascript:selectControl('water');">
                                <?php
                                if($node['m_water'] == 0) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="0" '.$str.'></option>';
                                if($node['m_water'] == 2) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="2" '.$str.'>есть</option>';
                                if($node['m_water'] == 1) { $str = 'selected'; } else { $str = ''; }
                                echo '<option value="1" '.$str.'>нет</option>';
                                ?>
                            </select>
                        </div>
